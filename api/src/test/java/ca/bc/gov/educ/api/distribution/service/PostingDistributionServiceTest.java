...
class PostingDistributionServiceTest {
  ...
  @Test
  void testProcessDistrictSchoolDistribution_withDistrictLabelNoIds() {
    Long batchId = 1L;
    UUID districtId = UUID.randomUUID();
    String districtReportType =ADDRESS_LABEL_YE;
    String transmissionMode = "transmissionMode";
  ...
  @Test
  void testProcessDistrictSchoolDistribution_withDistrictSchoolLabel() {
    Long batchId = 1L;
    UUID districtId = UUID.randomUUID();
    List<String> districtIds = List.of(districtId.toString());
    String districtReportType =ADDRESS_LABEL_SCH_YE;
    String transmissionMode = "transmissionMode";
  ...
  @Test
  void testProcessDistrictSchoolDistribution_withDistrictSchoolLabelNoIds() {
    Long batchId = 1L;
    UUID districtId = UUID.randomUUID();
    String districtReportType =ADDRESS_LABEL_SCH_YE;
    String transmissionMode = "transmissionMode";
